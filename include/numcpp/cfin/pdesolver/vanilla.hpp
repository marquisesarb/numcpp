...
#include <numcpp/cfin/pdesolver/interface.hpp>

namespace numcpp::cfin {

    class PDESolverLogVanillaEngine final: public PDESolverEngineInterface {

        public:
            PDESolverLogVanillaEngine(double S_, double K, double T, double mu, double r, double sigma, bool isCall, bool isAmerican, int N, int M, bool useCrankNicolson, double numberSigma = 5):
            PDESolverEngineInterface(N,M) {
